...
6. Publishing to production is done by the user via the Publish button — tell them when the project is ready to publish; don't try to deploy to PRODUCTION yourself.`;
